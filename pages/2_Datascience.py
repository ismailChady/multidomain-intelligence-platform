...
# This MUST match the real table: dataset_id, name, rows, columns, uploaded_by, upload_date
df = pd.DataFrame(rows, columns=[
    "ID", "Name", "Rows", "Columns", "Uploaded By", "Upload Date"
])

# SIDEBAR FILTER – filter by uploader instead of category (since CSV has no category)
...
# UPDATE DATASET FORM – here we’ll update rows/columns instead of category
